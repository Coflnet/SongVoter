...
{ 
    ...
    public partial class Song : IEquatable<Song>
    {
        ...
        /// </summary>
        [DataMember(Name="occurences", EmitDefaultValue=false)]
        public List<ExternalSong> Occurences { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Occurences: ").Append(Occurences).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Song other)
        {
            ...
            return 
                ...
                (
                    ...
                    Occurences != null &&
                    other.Occurences != null &&
                    Occurences.SequenceEqual(other.Occurences)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Occurences != null)
                    hashCode = hashCode * 59 + Occurences.GetHashCode();
                return hashCode;
            }
        }
